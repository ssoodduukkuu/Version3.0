...
@synthesize GenerateClearButton,LTime,_00,_01,_02,_03,_04,_05,_06,_07,_08,
...
- (IBAction)Generate_Click:(id)sender {
    NSString *scan=@"Scan";
    NSString *generate=@"Generate";
    
    if (GenerateClearButton.titleLabel.text==generate) {
        [GenerateClearButton setTitle:scan forState:UIControlStateNormal];
    ...
    {
        [GenerateClearButton setTitle:generate forState:UIControlStateNormal];
        /*******************************
         Second scene shows for calculating
         the level[9][9];
         *******************************/
    }
}
